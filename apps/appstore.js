...
const AppStoreApp = {
  create() {
    ...
    const APPS = [
      ...
      { id:'loans',       name:'NormBank Loans',   icon:'🏦', cat:'finance', price:0,    rating:3.9, reviews:4411, desc:'Borrow up to $50k. Default and lose everything. Good luck.', publisher:'NormBank Corp', builtIn:true, appId:'loans' },
      ...
      { id:'daemonvision',name:'DaemonVision Pro', icon:'👁', cat:'system',  price:999,  rating:5.0, reviews:1,    desc:'See what daemon.norm sees. Results may be unsettling. One-time purchase.', publisher:'daemon.norm Enterprises', builtIn:false },
      { id:'normhack',    name:'NormHack Terminal',icon:'💀', cat:'system',  price:2500, rating:4.1, reviews:342,  desc:'Enhanced terminal with hacking minigames and 47 Easter eggs.', publisher:'VoidSec LLC', builtIn:false },
      { id:'voidtracker', name:'VOID Tracker Pro', icon:'🌑', cat:'finance', price:500,  rating:3.2, reviews:891,  desc:'Real-time VoidToken alerts. Crash predictions (60% wrong). Panic button included.', publisher:'VoidCorp Analytics', builtIn:false },
      { id:'normrpg',     name:'NormRPG',          icon:'⚔️', cat:'games',   price:1500, rating:4.8, reviews:1200, desc:'Text RPG where your net worth is your HP. Buy gear. Fight kernel processes.', publisher:'NormGame Studios', builtIn:false },
      { id:'cryptopet',   name:'CryptoPet',        icon:'🐱', cat:'games',   price:200,  rating:4.6, reviews:4400, desc:'Desktop tamagotchi. Feed it NormCoin. Neglect it and it judges you publicly.', publisher:'PetDev Corp', builtIn:false },
      { id:'normsec',     name:'NormSecurity Suite',icon:'🛡',cat:'system',  price:750,  rating:4.7, reviews:621,  desc:'Firewall + virus scanner. Blocks 73% of attacks. The other 27% are from daemon.norm.', publisher:'NormSec Inc', builtIn:false },
      { id:'normdate',    name:'NormDate',         icon:'💘', cat:'social',  price:0,    rating:2.1, reviews:43,   desc:'Dating app for NormOS users. Matched by net worth. Currently 2 users.', publisher:'NormDate LLC', builtIn:false },
      { id:'normdocs',    name:'NormDocs',         icon:'📄', cat:'system',  price:150,  rating:3.8, reviews:234,  desc:'Create and edit documents. Exports as .normdoc which nothing else can open.', publisher:'NormSoft', builtIn:false },
    ];
